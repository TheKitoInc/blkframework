 ...
 */
package BLK.System.Utils.Coder;
...
public class Base64
    ...
    public String encode( byte[] b )
        ...
        if ( outputLength != sb.length() )
            {
                Logger.getLogger().warn("oops: minor program flaw: output length mis-estimated" + " estimate:" + outputLength + " actual:" + sb.length() );
            }
        return sb.toString();
        }// end encode
...
//
    ...
    {
        Base64 b= new Base64();
        return b.encode(value.getBytes());
    }
    public static String doDecode(String value)
    {
        Base64 b= new Base64();
        return new String(b.decode(value));
    }    
    }// end Base64
